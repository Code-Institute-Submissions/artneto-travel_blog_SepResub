...
from .views import UserRegisterView, UserEditView, PasswordsChangeView,\
                    ShowProfilePageView, EditPageProfile, CreateProfilePage
from .import views
...
urlpatterns = [
    ...
    path('<int:pk>/edit_profile_page/', EditPageProfile.as_view(),
         name='edit_profile_page'),
    path('create_profile_page/', CreateProfilePage.as_view(),
